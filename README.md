...
NAME: BJW PLUMBERS AND PROJECT PTY LTD 

ORGANISATION DESCRIPTION: 

BJW Plumbers and Project is a company that deals with various labor work that is needed by communities, big buildings, /smalls, and in rural areas.  

We are mostly dealing with plumbing which includes (bathroom making, bathroom renovation, shower installation, Pump installation, Bow hole, Septic tanks, Geyser installation, Drainage system, Leak detection and more. Our clients need more of our services according to their needs.  

Our target audience is communities, companies from rural and urban areas that require our services.  
...
NO of people visiting the website 

20-50 ppl per day 

An online tool (Google) is free and accessible to many 

How is the website (speed) 

In a stable network in 2 seconds its opens 
...
The website contains all essential pages (Home, About, Services, Contact, Login).  

Users can request quotations through the quote form.  

Contact information and Google Maps are provided.  

JavaScript validation improves user interaction.  

Navigation is simple and easy to understand.  

Images and company branding are included.  
...
No emergency call-out form.  

Navigation layouts could be more modern.  
...
Quote request forms improve customer interaction.  

Contact information is visible on all pages.  
...
Your lecturer will expect this. 6.2 GitHub Repository 

Source Code Repository 

 https://github.com/amahleshozi09-debug/ST10531480 

 

Accessibility and SOE  

Since your website uses images and forms, add: 
...
Keywords related to plumbing services.  
...
Picture2 (camera photo) 

  Copper water pipes and taps 

Picture3(camera photo)                     Picture4 

                    Fittings underneath a sinkpicture5  
...
Input details(login/signup) 

Input problem to get a quote 

Input Services required for quote and availability 
...
I fixed html contact navigation headers to be consistent, and they now start with capital letters also this applied on index, contact, about, login, and services. 

I improved the website by making it more professional, responsive, user-friendly, and interactive through CSS styling and JavaScript functionality. 

1. Home Page (index.html) 

Added a cleaner and more modern layout.  

Styled the company introduction section for better readability.  

Added a "Get a Free Quote" button.  

Improved spacing, fonts, and colours.  

Made images responsive on mobile devices.  
...
Visitors can easily understand the company services and quickly request a quote. 

2. About Page (Home.html) 

Better formatting of company information.  

Improved headings for Mission and Vision sections.  
...
Clickable image preview feature.  

Responsive image display.  

Creates a more professional company profile and improves user engagement. 

 

3. Services Page (services.html) 

Redesigned services into professional service cards.  
...
Service cards animate when hovered over.  

Improved visual interaction.  

Services are easier to browse and look more professional. 

4. Contact Page (contact.html) 

Redesigned contact form.  

Styled input fields, buttons, and labels.  

Improved Google Maps display.  
...
Makes it easier for customers to contact the company and reduces form errors. 

5. Login Page (login.html) 

Styled login and signup form.  

Improved form layout and appearance.  
...
Success notifications for login/signup actions.  

Provides a more professional membership registration experience. 

6. Navigation Menu (All Pages) 

Consistent navigation design across the website.  

Added hover effects.  

Mobile-friendly navigation layout.  

Users can move between pages easily and consistently. 

7. Header Improvements (All Pages) 

Professional company branding section.  

Better logo sizing.  

Improved company title and slogan display.  

Consistent blue company theme.  

Strengthens the company identity and makes the site look more trustworthy. 

8. Footer Improvements (All Pages) 
...
Added automatic copyright year.2026 

Provides a cleaner professional finish to every page. 
...
The website looks modern and works well on different screen sizes. 
...
Makes the website interactive and improves the user experience. 

Overall Result 

The website was transformed from a basic static website into a responsive, professional plumbing company website with: 
...
JavaScript validation and effects 
...
Plumbers, G. (2026). Ganga plumbers. [online] Ganga Plumbers. Available at: https://gangaplumbers.co.za [Accessed 19 Mar. 2026]. 

 

PLUMBERS, A. (2025). Oasis Plumbers. [online] Oasis plumbers. Available at: https://oasisplumbers.co.za [Accessed 15 Mar. 2026]. 

 

Africa, P. (2026). PLUMB AFRICA. [online] PLUMB AFRICA. Available at: https://plumbafrica.co.za [Accessed 15 Mar. 2026]. 

 

Pictures were taken by smart phone. 
